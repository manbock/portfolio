...
console.log(document.querySelectorAll('.circle'))//유사배열
let circles=[...document.querySelectorAll('.circle')]
console.log(circles)//진짜 배열

circles.shift(); // 배열 맨앞 요소 제거
console.log(circles)
...
let width=window.innerWidth; //뷰포트 넓이
let height=window.innerHeight; //뷰포트 높이
let x=0;
let y=0;
